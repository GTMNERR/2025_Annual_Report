...
#| echo: false
#| fig.cap: Monthly wind speed and direction from the Pellicer Creek weather station for January - December 2025.
#| fig.subcap:
#|    - "Monthly wind speeds"
#| layout-ncol: 1
...
Note that the water level data at Pellicer Creek only includes data from 2021–2025, which is due to this station switching from reporting depth to reporting level (NAVD88) in 2021  (@fig-range-depth-4).
...
There no freeze events in 2025 that recorded air temperature readings at or below -4°C.
...
#| echo: false
#| tbl-cap: "Date and duration of air temperatures less than or equal to 0 degrees C for greater than 2 hours at Pellicer Creek weather station."
...
```{r}
#| label: tbl-low-temp-occurrences
#| echo: false
